...
Route::controller(ActiveUserController::class)->group(function(){
    ...
    Route::get('/all/instructor/check','AllInstructorA')->name('all.instructorA'); 
...
Route::get('/category/{id}/{slug}', [CourseController::class, 'categoryWise'])->name('category.wise');
Route::post('/toggle-wishlist/{courseId}', [WishlistController::class, 'toggleWishlist']);
Route::get('/get-wishlist', [WishlistController::class, 'getWishlist']);
Route::post('/courses/search', [CourseController::class, 'search']);
Route::post('/courses/filter/rating', [CourseController::class, 'filterByRating']);
Route::post('/courses/filter/level', [CourseController::class, 'filterByLevel']);
