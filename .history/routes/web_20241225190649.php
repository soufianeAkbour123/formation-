...
Route::get('/search', [CourseController::class, 'searchCourses'])->name('search.courses');
Route::get('/filter/level/{level}', [CourseController::class, 'filterByLevel'])->name('filter.level');
Route::get('/filter/rating/{rating}', [CourseController::class, 'filterByRating'])->name('filter.rating');
