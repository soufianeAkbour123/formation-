...
Route::get('/course/search', [CourseController::class, 'searchCourses'])->name('course.search');
Route::get('/course/filter', [CourseController::class, 'filterCourses'])->name('course.filter');
