...
class AdminController extends Controller
{
   ...
   public function AdminLogout(Request $request){
        ...
        return redirect('/admin/login'); $notification = array(
...
public function InstructorRegister(Request $request){
  ...
  $notification = array(
      'message' => 'Instructeur enregistré avec succès',
      'alert-type' => 'success'
  );
  ...
  return response()->json(['message' => 'La mise à jour du statut du compte a été effectuée avec succès.']);
}// End Method
...
public function UpdateCourseStatus(Request $request){
  ...
  return response()->json(['message' => 'Statut du cours mis à jour avec succès']);
