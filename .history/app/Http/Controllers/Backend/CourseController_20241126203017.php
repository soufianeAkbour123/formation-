    ...
    try {
        ...
        return response()->json([
            ...
            public function rescheduleSection(Request $request)
            {
                ...
                // Marquer la section originale comme reprogrammée
                $originalSection->is_cancelled = true;
                $originalSection->is_rescheduled = true;
                $originalSection->rescheduled_date = $request->date; // Ajoutez ce champ à votre migration
                $originalSection->rescheduled_start_time = $request->start_time;
                $originalSection->rescheduled_end_time = $request->end_time;
                ...
                $newSection->is_rescheduled = false;
