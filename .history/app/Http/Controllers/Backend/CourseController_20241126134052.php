        ...
        return response()->json([
            ...
            public function rescheduleSection(Request $request)
            {
                ...
                $validatedData = $request->validate([
                    ...
                    'link' => 'required|url',
                    'chapters' => 'sometimes|array', // Optionnel
                    'chapters.*.title' => 'sometimes|string|max:255'
                ], [
                ...
                try {
                    ...
                    $newSection->section_title = $validatedData['section_title'];
                    $newSection->date = $validatedData['date'];
                    $newSection->start_time = $validatedData['start_time'];
                    $newSection->end_time = $validatedData['end_time'];
                    $newSection->link = $validatedData['link'];
                    ...
                    if (!empty($validatedData['chapters'])) {
                        ...
                        if (!empty($lectureData)) {
                            CourseLecture::insert($lectureData);
                        }
                    }
