...
Message envoyé avec succès.',
    ...
    public function InstructorAllQuestion()
    {
        ...
        // Modifiez la requête pour inclure le comptage des messages non lus
        $question = Question::select('user_id', 'course_id', DB::raw('MAX(id) as id'),
            DB::raw('SUM(CASE WHEN is_read = 0 AND instructor_id = '.Auth::user()->id.' THEN 1 ELSE 0 END) as unread_count'))
