...
public function calendar() {     
    try {         
        ...
        // Default to true, assuming no courses initially
        $userHasNoCourses = true;
        $sections = collect(); // Create an empty collection

        // Fetch ordered course IDs with confirmed payments
        ...
        // If user has ordered courses, try to fetch sections
        if ($orderedCourseIds->isNotEmpty()) {
            ...
            // Update userHasNoCourses based on sections
