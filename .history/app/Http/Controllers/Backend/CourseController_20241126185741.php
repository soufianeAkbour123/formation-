    ...
    try {
        ...
        return response()->json([
            ...
            public function rescheduleSection(Request $request)
            {
                ...
                try {
                    $section = CourSection::findOrFail($request->section_id);
                    ...
                    $section->start_time = $startTime;
                    $section->end_time = $endTime;
                    $section->is_cancelled = false; // Réactiver la séance si elle était annulée
                    $section->is_postponed = false; // Réinitialiser le statut reporté
