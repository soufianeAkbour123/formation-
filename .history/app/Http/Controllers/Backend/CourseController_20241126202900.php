    ...
    try {
        ...
        return response()->json([
            ...
            public function rescheduleSection(Request $request)
            {
                ...
                $newSection->section_title = $originalTitle; // Gardez le titre original
                $newSection->is_rescheduled = false; // Mettre à false
                $newSection->is_cancelled = false;   // Mettre à false
                $newSection->save();
                ...
                // Supprimer complètement l'ancienne section
