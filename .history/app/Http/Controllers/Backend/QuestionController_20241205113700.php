...
Message envoyé avec succès.',
    ...
    public function InstructorAllQuestion(){
        ...
        // Récupérer les questions les plus récentes par utilisateur et cours
        $question = Question::select('user_id', 'course_id', DB::raw('MAX(id) as id'))
    ...
    public function QuestionDetails($id){
        ...
        // Récupérer tous les messages (questions et réponses) pour cette conversation
        ...
        return view('instructor.question.question_details', compact('question', 'allMessages'));
    }
