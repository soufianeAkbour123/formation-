...
public function calendar()
{
    ...
    // Si l'utilisateur n'est inscrit à aucun cours, rediriger avec un message
    if (empty($enrolledCourseIds)) {
        return redirect()->route('my.course')->with('info', 'Vous n\'êtes inscrit à aucun cours.');
    }

    // Récupérer les sections uniquement pour les cours inscrits
