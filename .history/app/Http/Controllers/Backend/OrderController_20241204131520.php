...
public function calendar()
{
    ...
    // Définir hasOrders en fonction de l'existence de commandes
    $hasOrders = $orderedCourseIds->isNotEmpty();

    // Si l'utilisateur n'a pas de commandes, retourner la vue avec un tableau vide
    if (!$hasOrders) {
    ...
    // Récupérer les sections pour les cours commandés
