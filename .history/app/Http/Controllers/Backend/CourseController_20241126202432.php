    ...
    try {
        ...
        return response()->json([
            ...
            public function rescheduleSection(Request $request)
            {
                ...
                // Modifier la section originale au lieu de créer une nouvelle
                $originalSection->date = $request->date;
                $originalSection->start_time = $request->start_time;
                $originalSection->end_time = $request->end_time;
                $originalSection->section_title = $originalTitle . ' (Reprogrammé)';
                $originalSection->is_rescheduled = true;
                $originalSection->is_cancelled = false; // Réinitialiser le statut annulé
                $originalSection->cancellation_reason = null;
