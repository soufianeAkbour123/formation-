          ...
          public function cancelSection(Request $request)
{
    ...
    if ($section->is_rescheduled) {
        return response()->json([
            'success' => false,
            'message' => 'Impossible d\'annuler une séance déjà reprogrammée'
        ], 422);
    }
    ...
    return response()->json([
        ...
        'is_rescheduled' => $section->is_rescheduled // Ajouter cette information dans la réponse
    ]);
}
