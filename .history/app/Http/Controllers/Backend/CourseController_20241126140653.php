        ...
        return response()->json([
            ...
            public function rescheduleSection(Request $request)
            {
                ...
                $validator = Validator::make($request->all(), [
                    ...
                    'link' => 'required|url',
                    'lectures' => 'sometimes|array', // Changez 'chapters' en 'lectures'
                    'lectures.*.title' => 'sometimes|string|max:255' // Validation pour chaque titre de lecture
                ], [
                ...
                try {
                    ...
                    // Ajouter les lectures à la nouvelle section
                    if ($request->has('lectures') && is_array($request->lectures)) {
                        foreach ($request->lectures as $lectureData) {
                            ...
                            $lecture->lecture_title = $lectureData['title'];
                            $lecture->save();
                        }
                    }
