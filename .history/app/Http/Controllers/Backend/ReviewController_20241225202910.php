...
class ReviewController extends Controller
{
    public function ShowReviewForm($courseId)
    {
        ...
        $message = null;
        $canSubmit = false; // Initialiser la variable $canSubmit par défaut à false
        ...
        if (!$isEnrolled) {
            ...
            return view('frontend.review.add_review', [
                'course' => null,
                'message' => $message,
                'canSubmit' => $canSubmit, // Passer la variable $canSubmit
            ]);
        }
        ...
        return view('frontend.review.add_review', [
            'course' => $course,
            'message' => $message, // Pas de message si l'utilisateur est éligible
            'canSubmit' => $canSubmit, // Passer la variable $canSubmit
        ]);
    }
