    ...
    try {
        ...
        return response()->json([
            ...
            public function rescheduleSection(Request $request)
            {
                ...
                $newSection->section_title = $originalTitle;  // Enlever "(Reprogrammé)"
                $newSection->is_rescheduled = false;  // Changez cette ligne
                $newSection->is_cancelled = false;    // Ajoutez cette ligne
                $newSection->save();
            
                // Copy the lectures to the new section
                ...
                // Soft delete or completely remove the original section
                $originalSection->delete(); // Ou utilisez soft delete si configuré
