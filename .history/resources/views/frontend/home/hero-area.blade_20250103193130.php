      ...
      <div class="lll">
        <div class="hero-content">
          ...
          <a href="#" class="theme-btn">Se Connecter / S'inscrire</a>
            ...
            <a href="https://www.youtube.com/embed/9tusoKSh0AU?si=34gz4OmOdTxqm2mh"
            class="btn-text video-play-btn mb-4" data-fancybox data-type="iframe">
                           Regarder l'aperçu<i class="la la-play icon-btn ml-2"></i></a>
          </div>
        </div>
        <div class="hero-image">
