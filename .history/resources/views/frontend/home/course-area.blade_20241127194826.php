...
<section class="course-area pb-120px">
   ...
   <div class="icon-element icon-element-sm shadow-sm cursor-pointer" title="Add to Cart" id="{{ $course->id }}" onclick="addToCart({{$course->id}} , '{{$course->course_name}}', '{{$course->instructor_id}}', '{{$course->course_name_slug}}')">
