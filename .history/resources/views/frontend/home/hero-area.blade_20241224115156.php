...
.hero-content .section__title {
    font-size: 45px;    /* Réduit de 65px à 45px */
    line-height: 55px;  /* Réduit de 80px à 55px */
...
.hero-content .section__desc {
    ...
    line-height: 1.5;
    max-width: 500px;   /* Réduit de 700px à 500px */
    margin-left: auto;
    margin-right: auto;
...
.hero-btn-box {
    padding-top: 15px;  /* Réduit de 20px à 15px */
