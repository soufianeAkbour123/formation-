<section class="hero-area">
    <style>
        /* Styles pour uniformiser les sliders */
.hero-slider-item {
    min-height: 600px;  /* Hauteur minimale fixe pour tous les sliders */
    padding: 80px 0;    /* Padding vertical uniforme */
...
/* Uniformisation du conteneur de contenu */
.hero-content {
    width: 100%;
    max-width: 1200px;  /* Largeur maximale pour maintenir la cohérence */
    margin: 0 auto;
}
...
.hero-content .section__title {
    ...
    line-height: 80px;
    margin-bottom: 20px;
    max-width: 800px;   /* Largeur maximale pour le titre */
    margin-left: auto;
    margin-right: auto;
}
...
/* Uniformisation de la boîte de boutons */
.hero-btn-box {
    padding-top: 20px;
    gap: 1rem;         /* Espacement uniforme entre les boutons */
}
        </style>
    <!-- <style>
        .hero-slider-item {
