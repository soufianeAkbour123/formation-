...
/* Bestseller badge (red circle) */
.course-badge-labels .course-badge:not(.blue):not(.sky-blue) {
    position: absolute;
    top: -10px;  /* Moved up to overlap with the image */
    left: -10px;
...
/* NEW badge (corner triangle) */
.course-badge-labels .course-badge.blue {
    position: absolute;
    top: 0;
    right: 0;
...
/* Make sure course image container has proper positioning */
.card-image {
    position: relative;
    overflow: hidden;
}

/* Ensure course image takes full width */
.card-image img {
    width: 100%;
    height: auto;
    display: block;
