...
<section class="course-area pb-120px">
    ...
    @endphp
            ...
            <div class="card-body">
                ...
                <div class="course-card-pricing d-flex justify-content-between align-items-center">
    @if ($course->discount_price == NULL)
        <p class="card-price text-dark fw-bold">{{ $course->selling_price }} DH</p>
    @else
        <div class="price-container">
            <p class="card-price text-primary fw-bold">{{ $course->discount_price }} DH 
                <span class="text-muted text-decoration-line-through ms-2 fw-normal">{{ $course->selling_price }} DH</span>
            </p>
        </div>
    @endif
    ...
    <button class="btn-cart-modern" 
        ...
        <i class="la la-shopping-cart me-1"></i>
        <span>Panier</span>
    </button>
</div>
...
.card-price .text-decoration-line-through {
    font-size: 0.8em;
    color: #6c757d;
}
</style>
