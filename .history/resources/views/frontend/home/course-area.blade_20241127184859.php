...
<STYle>
    .card-title a {
    display: inline-block; /* Permet de limiter le texte dans un conteneur */
    white-space: nowrap; /* Empêche le retour à la ligne */
    overflow: hidden; /* Cache le texte qui dépasse */
    text-overflow: ellipsis; /* Ajoute "..." pour les débordements */
    max-width: 100%; /* Facultatif, limite la largeur */
    color: #333; /* Facultatif, ajuste la couleur du texte */
    text-decoration: none; /* Supprime la sous-ligne */
}

.card-title a:hover {
    color: #EC5252; /* Couleur au survol */
    text-decoration: underline; /* Facultatif : soulignez le texte au survol */
}
