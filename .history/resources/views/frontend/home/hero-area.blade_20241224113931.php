    ...
    <div class="hero-slider owl-action-styled">
            ...
            <div class="container">
                <div class="hero-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title text-white fs-65 lh-80 pb-3">Nous vous aidons à apprendre <br> ce que vous aimez</h2>
        ...
        <div class="hero-slider-item hero-bg-2" style="padding: 80px 0;">
            <div class="container">
                <div class="hero-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title text-white fs-65 lh-80 pb-3">The Ultimate learning experience <br> Vos cours synchrones pour la première fois au Maroc !</h2>
                        <p class="section__desc text-white pb-4">
