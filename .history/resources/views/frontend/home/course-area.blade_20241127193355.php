...
<section class="course-area pb-120px">
    ...
    @if ($course->discount_price == NULL)
    <p class="card-price text-black font-weight-bold mb-2 mb-md-0">{{ $course->selling_price }} DH</p>
    @else
    <p class="card-price text-black font-weight-bold mb-2 mb-md-0">{{ $course->discount_price }} DH <span class="before-price font-weight-medium">{{ $course->selling_price }} DH</span></p> 
    @endif

    <div class="d-flex align-items-center w-100 justify-content-between">
        <button type="submit" class="btn theme-btn flex-grow-1 mr-3" onclick="addToCart({{$course->id}} , '{{$course->course_name}}', '{{$course->instructor_id}}', '{{$course->course_name_slug}}')">
