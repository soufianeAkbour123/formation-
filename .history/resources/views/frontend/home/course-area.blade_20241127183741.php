...
.card-title.expanded + .see-more-btn {
...
seeMoreBtns.forEach((btn, index) => {
  btn.addEventListener('click', () => {
    cardTitles[index].classList.toggle('expanded');
    btn.textContent = cardTitles[index].classList.contains('expanded') ? 'See Less' : 'See More';
  });
});
    </script>
@endforeach