...
/* Style pour le badge Bestseller */
.course-badge.bestseller-badge {
    position: absolute;
    top: 10px;
    left: 10px;
...
.course-badge.bestseller-badge::before {
    content: "";
    position: absolute;
    top: 0;
    left: 0;
    ...
    <div id="tooltip_content_1{{ $item->id }}">
        <div class="card card-item">
            <div class="card-body">
                ...
                @if ($course->bestseller == 1)
        <div class="course-badge bestseller-badge">
            <span class="bestseller-text">Best<br>Seller</span>
        </div>
    @elseif ($course->discount_price == NULL)
        <div class="course-badge new-badge"></div>
    @endif
