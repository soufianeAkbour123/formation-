<section class="hero-area">
    <style>
        /* Styles pour uniformiser les sliders avec taille réduite */
.hero-slider-item {
...
.hero-content {
    width: 100%;
    max-width: 1000px;  /* Largeur maximale légèrement réduite */
    margin: 0 auto;
}

/* Uniformisation des titres avec taille réduite */
.hero-content .section__title {
    font-size: 45px;    /* Taille de police réduite */
    line-height: 55px;  /* Interligne réduit */
    margin-bottom: 15px;
    max-width: 700px;
    margin-left: auto;
    margin-right: auto;
