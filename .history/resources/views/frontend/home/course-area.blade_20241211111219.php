...
<section class="course-area pb-120px">
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div class="icon-element icon-element-sm shadow-sm cursor-pointer mr-2" 
        ...
        cursor-pointer" title="Add to Wishlist" id="{{ $course->id }}" onclick="addToWishList(this.id)">
...
function showCourseDetails(courseId) {
    // Vous pouvez personnaliser cette fonction pour afficher les détails du cours
    console.log('Détails du cours : ' + courseId);
}
</script>
