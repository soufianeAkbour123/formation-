...
<section class="course-area pb-120px">
    <div class="container">
        ...
        <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="all-tab" data-toggle="tab" href="#business" role="tab" aria-controls="business" aria-selected="true">Tout</a>
            </li>
        ...
        <div class="container">
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="business" role="tabpanel" aria-labelledby="business-tab">
                    <div class="row">
                        ...
                        <div class="col-lg-4 responsive-column-half mb-4 position-relative">
                            ...
                            <div class="position-absolute bottom-0 start-0 end-0 p-3">
                                <button type="submit" class="btn theme-btn w-100" onclick="addToCart({{$course->id}} , '{{$course->course_name}}', '{{$course->instructor_id}}', '{{$course->course_name_slug}}')">
            ...
            <div class="more-btn-box mt-4 text-center">
                <a href="course-grid.html" class="btn theme-btn">
                    Parcourir les formations <i class="la la-arrow-right icon ml-1"></i>
                </a>
            </div>
        </div>
    </div>
