...
<!-- Ajoutez cette div pour le lecteur vidéo -->
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.section-title, .lecture-title').forEach(function (element) {
        element.addEventListener('click', function (e) {
            ...
            if (videoUrl) {
                ...
                // S'assurer que le conteneur de la vidéo est visible
