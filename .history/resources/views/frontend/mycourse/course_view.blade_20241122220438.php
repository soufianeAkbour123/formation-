...
<script>
    ...
    // Bloquer les touches d'impression écran et de capture
    document.addEventListener('keydown', function(e) {
        // Bloquer la touche Impr. écran
    ...
    // Bloquer l'enregistrement avec les extensions de navigateur
    window.addEventListener('blur', function() {
        // Vous pouvez ajouter des actions supplémentaires si nécessaire
    });

    // Méthode pour bloquer les tentatives de capture vidéo
...
// Désactiver l'enregistrement de la vidéo
document.getElementById('videoContainer').addEventListener('canplay', function() {
    this.disablePictureInPicture = true;
    this.controlsList = 'nodownload noplaybackrate';
});
    </script>
