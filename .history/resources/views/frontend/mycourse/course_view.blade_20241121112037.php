        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-5">
                <div class="leave-rating mt-5">
                    ...
                    <label for="star5" class="fs-45">Excellent !</label>
                    <input type="radio" name='rate' id="star4"/>
                    <label for="star4" class="fs-45">Très bien</label>
                    <input type="radio" name='rate' id="star3"/>
                    <label for="star3" class="fs-45">Bien</label>
                    <input type="radio" name='rate' id="star2"/>
                    <label for="star2" class="fs-45">Moyen</label>
                    <input type="radio" name='rate' id="star1"/>
                    <label for="star1" class="fs-45">Médiocre</label>
