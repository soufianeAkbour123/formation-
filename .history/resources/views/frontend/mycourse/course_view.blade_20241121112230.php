        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-5">
                <div class="leave-rating mt-5">
                    <div class="rating-items d-flex justify-content-center">
                        <input type="radio" name='rate' id="star5" class="sr-only">
                        <label for="star5" class="rating-label fs-45">Excellent !</label>
                        <input type="radio" name='rate' id="star4" class="sr-only">
                        <label for="star4" class="rating-label fs-45">Très bien</label>
                        <input type="radio" name='rate' id="star3" class="sr-only">
                        <label for="star3" class="rating-label fs-45">Bien</label>
                        <input type="radio" name='rate' id="star2" class="sr-only">
                        <label for="star2" class="rating-label fs-45">Moyen</label>
                        <input type="radio" name='rate' id="star1" class="sr-only">
                        <label for="star1" class="rating-label fs-45">Médiocre</label>
                    </div>
                    <div class="rating-result-text fs-20 pt-4">Votre évaluation</div>
