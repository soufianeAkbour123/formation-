...
<div class="curriculum-content p-4">
    <h2 class="text-center mb-4">Vos Séances</h2> <!-- Titre ajouté -->
    <div class="text-right mb-4">
        <button class="btn btn-primary" name="link">Rejoindre</button> <!-- Bouton "Rejoindre" ajouté -->
    ...
    <style>
        ...
        /* Couleur grisée pour les séances réalisées */
    ...
    <div class="course-timeline">
        ...
        @foreach ($sections as $sec)
            ...
            @php
                ...
                $isCompleted = Carbon::now()->isAfter(Carbon::parse($sec->end_time)); // Vérifie si la séance est dépassée

            @endphp
            <div class="timeline-section {{ $isCompleted ? 'session-completed' : '' }}"> <!-- Ajout de la classe pour griser la section -->
                ...
                <div class="timeline-header" data-toggle="collapse" data-target="#collapse{{ $sec->id }}" aria-expanded="false">
                    ...
                    <div class="section-status">
                        ...
                        <span class="float-right">{{ Carbon::parse($sec->start_time)->format('d/m/Y H:i') }}</span> <!-- Date de la séance à droite -->
                ...
                @if($isCompleted) <!-- Message pour les séances réalisées -->
                        ...
                        <div class="lecture-grid">
                            ...
                            @foreach ($lecture as $lect)
                                <div class="lecture-card">
                                    ...
                                    <div class="text-right"> <!-- Bouton pour voir les vidéos enregistrées -->
