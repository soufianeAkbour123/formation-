...
@foreach ($section as $sec)
    <div class="card">
        <div class="card-header" id="headingOne{{ $sec->id }}">
            <button class="btn btn-link section-btn" type="button" 
...
<div id="videoPlayer" class="mt-3">
    <video controls width="100%" id="sectionVideo">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const videoPlayer = document.getElementById('sectionVideo');
    ...
    sectionButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            // Retire la classe active des autres sections
            sectionButtons.forEach(btn => btn.classList.remove('active-section'));

            // Ajoute la classe active à la section cliquée
