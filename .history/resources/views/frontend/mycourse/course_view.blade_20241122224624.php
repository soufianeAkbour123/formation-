...
@endforeach
<script>
    // Désactivation des captures d'écran
    ...
    // Désactivation du clic droit globalement
    document.addEventListener('contextmenu', (event) => event.preventDefault());
</script>

<style>
    /* Empêcher les interactions avec les vidéos (protection basique) */
    .video-container {
        position: relative;
    }
</style>
