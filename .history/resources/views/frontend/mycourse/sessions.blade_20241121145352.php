...
<div class="course-timeline">
    @foreach ($sections as $sec)
        @php
            ...
            $isOngoingSession = $sessionDate->isToday() && $now->between($sessionStartTime, $sessionEndTime);
        @endphp
        <div class="timeline-section {{ $sec->is_cancelled ? 'cancelled-session' : '' }} {{ $isPastSession ? 'past-session' : '' }}">
            ...
            <div>
                @if(!$sec->is_cancelled)
                    ...
                    @else
                        @if($sec->video_url)
                            <a href="#" class="modern-btn modern-btn-recording" target="_blank" data-video-url="{{ $sec->video_url }}">
