                    ...
                    @foreach ($lectures as $lect)
                        <li class="course-item-link active">
                            <div class="course-item-content-wrap">
                                ...
                                <div class="course-item-content">
                                    <h4 class="fs-15 lecture-title" data-video-url="{{ $lect->video_url }}" data-content="{!! $lect->content !!}">{{ $lect->lecture_title }}</h4>
                                </div><!-- end course-item-content -->
                            </div><!-- end course-item-content-wrap -->
                        </li>
                    @endforeach
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.section-title').forEach(function (button) {
            button.addEventListener('click', function (event) {
                ...
                if (videoUrl) {
                    window.location.href = videoUrl; // Redirection vers l'URL vidéo
                }
            });
        });
