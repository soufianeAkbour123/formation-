...
<div class="course-timeline">
    ...
    @php
        ...
        } elseif ($sessionDate->isBefore(Carbon::now())) {
            $sessionStatus = 'past';
        } elseif ($sessionDate->isToday() && Carbon::now()->between($sessionStartTime, $sessionEndTime)) {
            $sessionStatus = 'ongoing';
        } else {
            $sessionStatus = 'upcoming';
        }
    @endphp
    <div class="timeline-section {{ $sessionStatus }}">
        <div class="timeline-header" data-toggle="collapse" data-target="#collapse{{ $sec->id }}" aria-expanded="false">
            <div class="section-status">
                <div class="status-indicator">
                    <i class="la {{ $sessionStatus == 'cancelled' ? 'la-ban text-danger' : ($sessionStatus == 'past' ? 'la-check' : 'la-book-open') }}"></i>
                </div>
