...
@foreach ($section as $sec)
    ...
    <div class="card">
        <div class="card-header" id="headingOne{{ $sec->id }}">
            <button class="btn btn-link section-title" type="button" 
        ...
        <div id="collapseOne{{ $sec->id }}" class="collapse" aria-labelledby="headingOne{{ $sec->id }}" data-parent="#accordionCourseExample">
            <div class="card-body p-0">
                <div id="videoContainer{{ $sec->id }}" class="video-container" style="display: none;">
...
<!-- Ajoutez ce div pour le lecteur vidéo principal -->
<div id="mainVideoPlayer" class="main-video-player">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Gestion des clics sur les titres des sections
    document.querySelectorAll('.section-title').forEach(function (button) {
        button.addEventListener('click', function () {
            ...
            if (videoUrl) {
                ...
                // Faire défiler jusqu'au lecteur vidéo
                videoPlayer.scrollIntoView({ behavior: 'smooth' });
            }
        });
    });
    
    // Gestion des clics sur les titres des lectures
    document.querySelectorAll('.lecture-title').forEach(function (title) {
