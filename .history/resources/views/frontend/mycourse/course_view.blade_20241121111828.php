...
<div class="modal fade modal-container" id="ratingModal" tabindex="-1" role="dialog" aria-labelledby="ratingModalTitle" aria-hidden="true">
    ...
    <label for="star5" class="fs-45">5 étoiles</label>
    <input type="radio" name='rate' id="star4"/>
    <label for="star4" class="fs-45">4 étoiles</label>
    <input type="radio" name='rate' id="star3"/>
    <label for="star3" class="fs-45">3 étoiles</label>
    <input type="radio" name='rate' id="star2"/>
    <label for="star2" class="fs-45">2 étoiles</label>
    <input type="radio" name='rate' id="star1"/>
    <label for="star1" class="fs-45">1 étoile</label>
    <div class="rating-result-text fs-20 pb-4">Votre évaluation</div>
</div>
            </div><!-- fin modal-body -->
