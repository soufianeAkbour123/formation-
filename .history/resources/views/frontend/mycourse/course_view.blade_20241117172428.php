    ...
    <div class="card">
        ...
        <div id="collapseOne{{ $sec->id }}" 
            ...
            <div class="card-body p-0">
                ...
                <div class="video-container" id="video{{ $sec->id }}"></div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.section-checkbox').forEach(function (checkbox) {
        checkbox.addEventListener('change', function () {
            ...
            const videoContainer = document.getElementById('video' + sectionId);
            ...
            if (this.checked && videoUrl) {
                ...
                const collapseElement = document.getElementById('collapseOne' + sectionId);
                if (collapseElement) {
                    collapseElement.classList.add('show');
                }
            } else {
                // Supprimer la vidéo si décochée
                videoContainer.innerHTML = '';
            }
        });
    });

    // Désactiver le comportement de redirection du bouton
