...
<style>
    ...
    .btn-secondary:hover {
        background-color: #6366f1; /* Couleur de fond au survol */
        transform: translateY(-2px);
    }

    .modern-btn {
        background-color: #28a745; /* Couleur de fond pour le bouton "Rejoindre" */
        color: white; /* Couleur du texte */
        border: none;
        border-radius: 8px;
        padding: 10px 20px;
    ...
    .modern-btn:hover {
        background-color: #218838; /* Couleur de fond au survol pour "Rejoindre" */
        transform: translateY(-2px);
    }

    .modern-btn-secondary {
        background-color: #007bff; /* Couleur de fond pour le bouton "Voir le cours enregistré" */
        color: white; /* Couleur du texte */
        border: none;
        border-radius: 8px;
        padding: 10px 20px;
    ...
    .modern-btn-secondary:hover {
        background-color: #0056b3; /* Couleur de fond au survol pour "Voir le cours enregistré" */
        transform: translateY(-2px);
    }
</style>
        ...
        <div class="timeline-section">
            <div class="timeline-header" data-toggle="collapse" data-target="#collapse{{ $sec->id }}" aria-expanded="false">
                ...
                <div>
                    ...
                    <a href="{{ $sec->recorded_course_link }}" class="modern-btn modern-btn-secondary" target="_blank">Voir le cours enregistré</a>
                </div>
            </div>
