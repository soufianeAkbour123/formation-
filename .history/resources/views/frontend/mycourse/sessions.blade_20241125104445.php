...
<div class="course-timeline">
    ...
    @elseif(!$isPastSession)
        @if($sec->link)
            <a href="{{ $sec->link }}" class="modern-btn join-btn" target="_blank">Rejoindre</a>
        @else
            <span class="waiting-recording">SA
Le lien de la session sera bientôt disponible JE VEUX REMPLACER SESSION PAR LA SEANCE


Je vais modifier le message en remplaçant "session" par "séance" :
