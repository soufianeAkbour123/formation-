...
@if(!$hasOrders)
    <div class="alert alert-info text-center p-4 m-4">
        <h4>Aucune formation commandée</h4>
        <p>Vous n'avez pas encore commandé de formation. Veuillez d'abord vous inscrire à une formation pour voir le calendrier des sessions.</p>
