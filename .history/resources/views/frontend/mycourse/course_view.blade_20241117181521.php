...
<div class="card">
    <div class="card-header" id="heading{{ $sec->id }}">
        <div class="d-flex align-items-center">
            <input type="checkbox" class="video-checkbox me-2" data-video-url="{{ $sec->video_url }}">
            <button class="btn btn-link collapsed w-100 text-start" type="button" 
    ...
    <div id="collapse{{ $sec->id }}" class="collapse" 
        ...
        <div class="card-body p-0">
            <ul class="curriculum-sidebar-list list-unstyled mb-0">
                <li class="course-item-link">
                    <div class="course-item-content-wrap p-3">
                        <div class="course-item-content">
                            <h4 class="fs-15 lecture-title mb-0">
                                {{ $sec->section_title }}
                            </h4>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const videoContainer = document.getElementById('videoContainer'); // Make sure you have this element in your HTML
    ...
    checkboxes.forEach(checkbox => {
        checkbox.addEventListener('change', function() {
            ...
            if (this.checked && videoUrl) {
                ...
                // Clear video container when unchecked
