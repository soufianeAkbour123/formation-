...
<ul class="nav nav-tabs generic-tab" id="myTab" role="tablist">
    <li class="nav-item">
        <a class="nav-link" id="overview-tab" data-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Aperçu</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="question-and-ans-tab" data-toggle="tab" href="#question-and-ans" role="tab" aria-controls="question-and-ans" aria-selected="false">Questions & Réponses</a>
    </li>
</ul>
</div>
    ...
    <div class="media-body">
        <div class="d-flex align-items-center justify-content-between">
            <div class="question-meta-content">
                <!-- Enlever les liens <a> et garder uniquement le contenu -->
...
<div class="media media-card border-bottom border-bottom-gray py-4 px-3" style="background: #e6e6e6; margin-left: 40px;">
    <div class="media-img rounded-full flex-shrink-0 avatar-sm">
        <img class="rounded-full" src="{{ (!empty($rep->instructor->photo)) ? url('upload/instructor_images/'.$rep->instructor->photo) : url('upload/no_image.jpg')}}" alt="Photo instructeur">
    </div>
    <div class="media-body">
        <div class="d-flex align-items-center justify-content-between">
            <div class="question-meta-content">
                <!-- Enlever le lien <a> et garder uniquement le contenu -->
                <h5 class="fs-16 pb-1">{{ $rep->instructor->name }}</h5>
                <p class="fs-15 text-gray">{{ $rep->question }}</p>
            </div>
        </div>
        <p class="meta-tags pt-1 fs-13">
