                ...
                @foreach ($section as $sec)
                    <div class="card">
                        <div class="card-header" id="headingOne{{ $sec->id }}">
                            <button class="btn btn-link w-100 d-flex justify-content-between align-items-center" type="button" 
                        ...
                        <div id="collapseOne{{ $sec->id }}" class="collapse"
                            ...
                            <div class="card-body p-2">
                                <h4 class="fs-15 lecture-title" data-video-url="{{ $sec->video_url }}">
                                    Video: {{ $sec->section_title }}
                                </h4>
                            </div><!-- end card-body -->
                        </div><!-- end collapse -->
                    </div><!-- end card -->
