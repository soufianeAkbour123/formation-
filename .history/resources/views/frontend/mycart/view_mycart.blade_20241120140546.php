...
<section class="cart-area section-padding">
    ...
    @if(Session::has('coupon'))
        <div class="coupon-details">
            <p>Code Promo: {{ Session::get('coupon')['coupon_name'] }}</p>
            <p>Réduction: {{ Session::get('coupon')['coupon_discount'] }}%</p>
            <button onclick="couponRemove()" class="btn btn-danger">Supprimer le coupon</button>
        </div>
    @else
