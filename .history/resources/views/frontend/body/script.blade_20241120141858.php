...
{{-- /// Apply Coupon Start  // --}}
 ...
 function applyCoupon() {
    ...
    var current_course_id = $('#current_course_id').val(); // Ajoutez un champ caché avec l'ID du cours actuel
    ...
    $.ajax({
        ...
        data: {
            ...
            course_id: current_course_id, // Ajouter l'ID du cours pour vérification
