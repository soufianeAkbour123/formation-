                    ...
                    <div class="col-lg-6">
                        <div class="header-widget">
                            <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                                ...
                                <li class="d-flex align-items-center"><i class="la la-envelope-o mr-1"></i><a href="mailto:contact@aduca.com"> contact@suptechnology.ma</a></li>
                            </ul>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="logo-box">
                                ...
                                <a href="{{ url('/') }}" class="logo"><img src="{{ asset('frontend/images/852b463e-5bcc-4eb7-a556-29480123124f-removebg-preview.png') }}" alt="logo" width="250" height="250" ></a>
