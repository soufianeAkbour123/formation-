    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.error) {
                ...
                $('#promoCalField').html(`<div class="alert alert-danger">${data.error}</div>`);
                return;
            }
            ...
            if (data.promo_code) {
                $('#promoCalField').html(`
                    ...
                    <ul class="generic-list-item pb-4">
                        ...
                        <li class="d-flex align-items-center justify-content-between font-weight-semi-bold">
                            <span class="text-black">Reduced Price:</span>
                            <span>-${data.discount_amount} DHS</span>
                        </li>
                        <li class="d-flex align-items-center justify-content-between font-weight-semi-bold">
        ...
        error: function(xhr, status, error) {
            ...
            $('#promoCalField').html(`<div class="alert alert-danger">Erreur de chargement des totaux</div>`);
        }
    });
}
