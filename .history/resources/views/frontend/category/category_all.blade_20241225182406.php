...
<section class="course-area section--padding">
    <div class="container">
       ...
       <ul class="generic-list-item">
           @foreach ($categories as $cat)
           <li>
               <a href="href="{{ url('category/'.$cat->id.'/'.$cat->category_slug) }}" 
                  class="course-category {{ request()->is('category/course/'.$cat->id) ? 'active-category' : '' }}">
                   {{ $cat->category_name }}
                   <span class="ml-auto">({{ $cat->courses->count() }})</span>
               </a>
           </li>
           @endforeach
