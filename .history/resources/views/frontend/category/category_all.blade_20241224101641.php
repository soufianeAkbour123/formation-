   ...
   function toggleWishlist(element) {
    ...
    function initializeWishlist() {
        fetch('/get-wishlist')
            .then(response => response.json())
            .then(data => {
                data.wishlist.forEach(courseId => {
                    const wishlistIcon = document.querySelector(`.wishlist-icon[data-course-id="${courseId}"]`);
                    if (wishlistIcon) {
