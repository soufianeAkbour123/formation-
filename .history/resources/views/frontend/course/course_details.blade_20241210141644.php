        ...
        <div class="col-lg-8 mr-auto">
            <div class="breadcrumb-content">
                ...
                @if ($course->bestseller == 1)
                    ...
                    @endif 
                    @php
$instructor = $course->instructor; // Supposant que vous avez une relation instructor dans votre modèle Course

// Récupérer tous les avis de l'instructeur pour tous ses cours
$reviewcount = App\Models\Review::whereHas('course', function($query) use ($instructor) {
    $query->where('instructor_id', $instructor->id);
})->where('status', 1)->latest()->get();

// Calculer la moyenne des notes pour tous les cours de l'instructeur
$avarage = App\Models\Review::whereHas('course', function($query) use ($instructor) {
    $query->where('instructor_id', $instructor->id);
