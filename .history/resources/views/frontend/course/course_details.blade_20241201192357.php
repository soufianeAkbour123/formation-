...
<div class="course-overview-card">
    <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
        ...
        <div class="curriculum-duration fs-15">
            <span class="curriculum-total__text mr-2"><strong class="text-black font-weight-semi-bold">Total:</strong> {{ $lecture->count() }} Chapitres</span>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-2">
                                    <div class="section-title d-flex align-items-center">
                                        {{ $sec->section_title }}
                                        @if($sec->is_cancelled && !$sec->is_rescheduled)
                                            <span class="badge badge-danger ml-2">Annulée</span>
                                        @elseif($sec->is_rescheduled)
                                            <span class="badge badge-warning ml-2">Reprogrammée</span>
                                        @endif
                                    </div>
                                    <span class="fs-15 text-gray font-weight-medium">
                                        {{ count($lecture) }} Chapitres
                                    </span>
                                    @if($sec->cancellation_reason)
                                        <div class="text-danger fs-13 mt-1">
                                            Raison: {{ $sec->cancellation_reason }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                            @if($sec->start_time && $sec->end_time)
                                <div class="modern-schedule-info">
                                    <div class="date-container">
                                        ...
                                        @if($sec->link)
                                            <div class="meeting-link mt-2">
                                                <a href="{{ $sec->link }}" target="_blank" class="btn btn-sm btn-primary">
                                                    <i class="la la-video"></i> Rejoindre la séance
                                                </a>
                                            </div>
                                        @endif
                                    </div>
                        ...
                        <div class="card-body">
                            @if($sec->note)
                                <div class="alert alert-info mb-3">
                                    <i class="la la-info-circle"></i> {{ $sec->note }}
                                </div>
                            @endif
                           ...
                           <div class="d-flex flex-wrap align-items-center pb-4">
                               ...
                               <div class="select-container mb-3">
                                   <select class="select-container-select">
                                       <option value="all-rating">All Avis</option>
                       ...
                       <form method="post" class="row">
                           ...
                           <div class="btn-box col-lg-12">
                               <div class="custom-control custom-checkbox mb-3 fs-15">
                                   ...
                                   Enregistrer mon nom et mon email dans ce navigateur pour la prochaine fois que je commenterai
                                   </label>
                               </div><!-- end custom-control -->
                               <button class="btn theme-btn" type="submit">Ajouter un avis</button>
                           </div><!-- end btn-box -->
                       </form>
                   </div><!-- end course-overview-card -->
