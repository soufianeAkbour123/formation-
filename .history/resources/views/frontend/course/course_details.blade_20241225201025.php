...
<div class="course-overview-card border border-gray p-4 rounded">
   ...
   @endphp
    ...
    @endforeach
        ...
        <p>
            <b>
                Pour ajouter un avis sur le cours, vous devez d'abord vous connecter. 
    ...
    @else
                ...
                <form method="post" action="{{ route('store.review') }}" class="row">
                    ...
                    <div class="input-box col-lg-12">
                        ...
                        <div class="form-group">
                            <textarea class="form-control form--control pl-3" name="comment" placeholder="Écrire un message" rows="5" required></textarea>
                        </div>
                    </div>
        ...
        @else
            <div class="alert alert-info">Vous n'êtes pas éligible pour soumettre un avis.</div>
        @endif
    @endguest
