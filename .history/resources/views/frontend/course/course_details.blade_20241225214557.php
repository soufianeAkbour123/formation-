...
<style>
    ...
    display: flex;
    flex-wrap: wrap;
    gap: 20px; /* Optional: to add space between cards */
}

.related-course-area .card-item {
    flex: 1 1 25%; /* Ensures 4 cards per row, adjust percentage to fit your layout */
    ...
    background-color: white;
    box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); /* Optional: card shadow for aesthetics */
}
...
.related-course-area .card-image img {
    object-fit: cover; /* Ensures images cover the card space evenly */
