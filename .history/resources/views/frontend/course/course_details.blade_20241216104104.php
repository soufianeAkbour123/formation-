...
<section class="breadcrumb-area pt-50px pb-50px bg-white pattern-bg">
   ...
   @endphp                 
    ...
    @endphp
                        <span class="student-total pl-2">{{ number_format($enrollmentCount) }} étudiants</span>
                    </div>
                </div><!-- end d-flex -->
    ...
    <b>Date Fin :</b> {{ \Carbon\Carbon::parse($course->date_fin)->format('d/m/Y') }} 
                ...
                <div class="bread-btn-box pt-3">
                    ...
                    <button class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 mr-2 mb-2" data-toggle="modal" data-target="
                    ">
