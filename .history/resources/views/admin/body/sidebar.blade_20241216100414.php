...
<ul>
    <li> <a href="{{ route('admin.pending.review') }}"><i class='bx bx-radio-circle'></i>Avis en attente </a>
    </li>
    <li> <a href="{{ route('admin.active.review') }}"><i class='bx bx-radio-circle'></i>Avis actifs </a>
    </li>
</ul>
</li>
<li>
    <a class="has-arrow" href="javascript:;">
        ...
        <div class="menu-title">Gérer tous les utilisateurs </div>
    </a>
    <ul>
        <li> <a href="{{ route('all.user') }}"><i class='bx bx-radio-circle'></i>Tous les utilisateurs </a>
        </li>
        <li> <a href="{{ route('all.instructorA') }}"><i class='bx bx-radio-circle'></i>Tous les formateurs</a>
        </li>
