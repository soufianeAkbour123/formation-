                            ...
                            <div class="list-group list-group-flush">
                                ...
                                <a href="{{ route('question.details', $q->id) }}" class="list-group-item">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            <h6 class="mb-0 chat-title">{{ $q['user']['name'] }}
                                                @if($q->unread_count > 0)
                                                    <span class="badge bg-danger rounded-pill float-end">{{ $q->unread_count }}</span>
                                                @endif
                                            </h6>
        ...
        @if($message->parent_id === null)
            ...
            <div class="chat-content-leftside">
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ms-2">
                        <p class="mb-0 chat-time d-flex justify-content-between">
            ...
            <div class="chat-content-rightside">
                <div class="d-flex ms-auto">
                    <div class="flex-grow-1 me-2">
                        <p class="mb-0 chat-time text-end d-flex justify-content-end align-items-center">
                            <span>you, {{ Carbon\Carbon::parse($message->created_at)->diffForHumans() }}</span>
                            @if(!$message->is_read)
                                <span class="badge bg-danger rounded-pill ms-2">New</span>
                            @endif
                        </p>
...
document.getElementById('searchUser').addEventListener('keyup', function() {
    ...
    chatList.forEach(function(chat) {
        let userName = chat.querySelector('.chat-title').textContent.toLowerCase();
