...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        e.preventDefault();
        errorHandlers.clearAllErrors(); // Nettoyer toutes les erreurs avant soumission
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (data.errors) {
                        ...
                        // Vérifier si c'est une erreur de conflit horaire
                        if (errorMessage.includes('Conflit horaire')) {
                            Swal.fire({
