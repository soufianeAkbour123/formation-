...
<div class="page-content">
    ...
    <div class="rescheduled-reason">
        Séance reprogrammée le {{ \Carbon\Carbon::parse($item->rescheduled_date)->format('d/m/Y') }}
        @if($item->rescheduled_start_time)
            de {{ $item->rescheduled_start_time }} 
            à {{ $item->rescheduled_end_time }}
        @endif
    </div>
    
    <!-- Boutons d'action pour une séance reprogrammée -->
    ...
    $.ajax({
        ...
        error: function(xhr, status, error) {
            ...
            Swal.fire({
                ...
                text: 'Une erreur est survenue lors de la reprogrammation.',
