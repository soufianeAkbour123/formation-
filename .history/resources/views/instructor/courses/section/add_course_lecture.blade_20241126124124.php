...
<div class="page-content">
    ...
    <div class="card-body">
        <div class="d-flex align-items-center">
            ...
            <button type="button" class="btn btn-secondary" onclick="planifierTeamsSeance()">
...
<script>
    function planifierTeamsSeance() {
    // Exemple simple : Redirection vers une page de planification
    window.location.href = "/teams/schedule?course_id={{ $course->id }}";
}
