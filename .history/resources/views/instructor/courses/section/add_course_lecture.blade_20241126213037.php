...
<div class="page-content">
    ...
    <div class="section-header" data-section="{{ $item->id }}">
        ...
        @elseif($item->is_rescheduled)
            ...
            <div class="rescheduled-details">
                Séance reprogrammée le {{ \Carbon\Carbon::parse($item->date)->format('d/m/Y') }}
            </div>
            ...
            <div class="section-main-info">
                <div class="section-title-container">
                    ...
                    <h6 class="mb-0 editable-section-title" data-id="{{ $item->id }}">
                        ...
                        @if(!$item->is_cancelled && !$item->is_rescheduled && !\Carbon\Carbon::parse($item->date)->isPast())
