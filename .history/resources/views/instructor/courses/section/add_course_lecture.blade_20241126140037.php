...
<div class="modal fade" id="rescheduleSectionModal" tabindex="-1">
    ...
    data-bs-target="#rescheduleSectionModal"
...
<script>
 ...
 $(document).ready(function() {
    ...
    $('#rescheduleSectionModal').on('show.bs.modal', function (event) {
        // Optional: Reset form when modal opens
        $('#rescheduleSectionForm')[0].reset();
        
        // If you're passing specific data when opening the modal
