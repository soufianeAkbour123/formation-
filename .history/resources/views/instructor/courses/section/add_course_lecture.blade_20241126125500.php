        ...
        <div class="col-12">
            ...
            <div class="curriculum-content mt-4">
                <div class="accordion" id="courseAccordion">
                    ...
                    @php
                        $isPastSession = \Carbon\Carbon::parse($item->date)->isPast();
                    @endphp
                            ...
                            <div class="section-header-content">
                                <div class="section-main-info">
                                    ...
                                    <div class="action-buttons">
                                        ...
                                        @if($isPastSession)
                                            <!-- Pour les séances passées, seul le bouton de suppression est disponible -->
                                            <button class="btn btn-sm btn-danger delete-section" 
                                                    data-id="{{ $item->id }}" 
                                                    data-title="{{ $item->section_title }}">
                                                <i class="las la-trash"></i>
                                            </button>
                                        @elseif(!$item->is_cancelled && !$item->is_postponed)
                                            <button class="btn btn-sm btn-danger delete-section" 
                                                    data-id="{{ $item->id }}" 
                                                    data-title="{{ $item->section_title }}">
                                                <i class="las la-trash"></i>
                        ...
                        <div class="section-body" id="section-body-{{ $item->id }}">
                            ...
                            <div id="lecture-list-{{ $item->id }}">
                                ...
                                <div class="lecture-item">
                                    ...
                                    <div class="action-buttons">
                                        @if(!$item->is_cancelled && !$item->is_postponed)
...
.past-session .action-buttons {
    display: flex;
    justify-content: flex-end;
}

.past-session .action-buttons > *:not(.delete-section) {
    display: none;
}
</style>
