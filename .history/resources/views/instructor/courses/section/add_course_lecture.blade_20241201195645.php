...
<div class="course-section 
    ...
    <div class="section-header" data-section="{{ $item->id }}">
        ...
        @if(!$item->is_rescheduled)
            <!-- Si la séance est annulée mais pas encore reprogrammée -->
        ...
        @endif
        <!-- Toujours afficher le bouton supprimer pour une séance annulée -->
    ...
    @elseif($item->is_rescheduled && !\Carbon\Carbon::parse($item->date)->isPast())
        <!-- Si la séance est reprogrammée et pas dans le passé -->
