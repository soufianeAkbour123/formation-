...
@elseif($item->is_rescheduled)
    <div class="rescheduled-badge">REPROGRAMMÉ</div>  <!-- Ajout du badge reprogrammé -->
...
>
                    ...
                    <div class="mb-3">
                        <label class="form-label">Heure de début</label>
                        <input type="time" name="start_time" class="form-control" required step="300" />  <!-- Intervalles de 5 minutes -->
                        <div class="error-message text-danger mt-1"></div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Heure de fin</label>
                        <input type="time" name="end_time" class="form-control" required step="300" />  <!-- Intervalles de 5 minutes -->
                        <div class="error-message text-danger mt-1"></div>
                    </div>
...
<script>
    ...
    return `<input type="${inputType}" 
                   class="form-control" 
                   value="${value || ''}" 
                   ${inputType === 'date' ? `min="${today}"` : ''}  <!-- Date minimale aujourd'hui -->
                   style="width: auto; display: inline-block;" />`;
}
