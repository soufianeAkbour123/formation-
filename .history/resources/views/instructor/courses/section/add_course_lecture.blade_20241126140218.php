...
<script>
  $('#rescheduleSectionForm').on('submit', function(e) {
    ...
    var formData = {
        ...
        original_section_id: $('#reschedule_original_section_id').val(),
        section_title: $('#reschedule_section_title').val(),
        date: $('input[name="date"]').val(),
        start_time: $('#reschedule_start_time').val(),
        end_time: $('#reschedule_end_time').val(),
        link: $('#reschedule_link').val(),
        chapters: originalData.chapters.map(chapter => ({ title: chapter.title }))
    };
    ...
    $.ajax({
        ...
        error: function(xhr) {
            ...
            if (errors) {
                ...
                errorMessage = "Une erreur s'est produite lors de la reprogrammation.";
            }
