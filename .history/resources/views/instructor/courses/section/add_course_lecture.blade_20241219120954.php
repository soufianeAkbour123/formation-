...
$(document).ready(function() {
    ...
    function updateAfterReschedule(sectionId, newDate, newStartTime, newEndTime) {
        const sectionContainer = $(`#section-container-${sectionId}`);
        
        // Mettre à jour les informations de date et d'heure
        sectionContainer.find('.date-text').text(newDate);
        sectionContainer.find('.start-time-text').text(newStartTime);
        sectionContainer.find('.end-time-text').text(newEndTime);
        
        // Ajouter une indication de reprogrammation
        sectionContainer.addClass('rescheduled-section');
        sectionContainer.find('.section-title-text').append(' (Reprogrammé)');
    }
    ...
    $('#rescheduleSectionForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    updateAfterReschedule(sectionId, newDate, newStartTime, newEndTime);
