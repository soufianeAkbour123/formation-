...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const validators = {
        ...
        times: () => {
            ...
            if (!date.value || !validators.date()) {
                errorManager.showError(date, 'Veuillez d\'abord sélectionner une date valide');
                return false;
            }
        ...
        ['input', 'change'].forEach(event => {
            input.addEventListener(event, () => {
                if (key === 'date') {
                    ...
                    // Valider les heures seulement si la date est valide
                    if (validators.date()) {
                        validators.times();
                    }
                }
