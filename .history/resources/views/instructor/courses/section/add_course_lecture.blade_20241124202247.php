            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (data.errors) {
                        ...
                        if (errorMessage.includes('créneau') || errorMessage.includes('horaire')) {
                            targetInput = inputs.startTime;
                        } else if (errorMessage.includes('date')) {
                            targetInput = inputs.date;
                        }

                        if (targetInput) {
                            errorManager.showError(targetInput, data.message);
                        } else {
                            Swal.fire({
                                title: 'Erreur',
                                text: data.message,
