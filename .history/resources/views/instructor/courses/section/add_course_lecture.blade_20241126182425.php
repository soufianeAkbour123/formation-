...
$('#rescheduleSectionForm').on('submit', function(e) {
    ...
    // Modifier la requête AJAX pour envoyer les lectures
    $.ajax({
        url: '{{ route("reschedule.course.section") }}',
        method: 'POST',
        data: $(this).serialize() + '&lectures=' + JSON.stringify(originalData.lectures),
