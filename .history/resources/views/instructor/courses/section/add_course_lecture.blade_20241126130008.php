...
<div class="page-content">
    <div class="row">
        <div class="col-12">
            <!-- Course Header Card - reste inchangé -->
                ...
                <div class="accordion" id="courseAccordion">
                    ...
                    <div class="course-section 
                        ...
                        <div class="section-header" data-section="{{ $item->id }}">
                            <!-- Postponement Banner - reste inchangé -->
                            ...
                            <div class="section-header-content">
                                <div class="section-main-info">
                                    ...
                                    <div class="action-buttons">
                                        @if($item->is_cancelled)
                                            <!-- Code pour séance annulée - reste inchangé -->
                                        @elseif($item->is_postponed)
                                            <!-- Code pour séance reportée - reste inchangé -->
                        ...
                        <div class="section-body" id="section-body-{{ $item->id }}">
                            <div id="lecture-form-{{ $item->id }}" style="display: none;" class="mb-3 p-3 bg-white rounded">
                                <!-- Formulaire de lecture - reste inchangé -->
                            </div>
...
.past-section, .cancelled-section {
        opacity: 0.7;
        background-color: #f4f4f4;
    }
    .past-section .edit-icon, .cancelled-section .edit-icon {
        display: none;
    }
    .cancellation-badge {
