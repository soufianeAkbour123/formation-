                            ...
                            <div class="section-header-content">
                                <div class="section-main-info">
                                    ...
                                    <div class="action-buttons">
                                        @if($item->is_cancelled)
                                            <!-- Pour les séances annulées, afficher les boutons de rétablissement et suppression -->
                                        ...
                                        @elseif(!$item->is_cancelled && !\Carbon\Carbon::parse($item->date)->isPast())
                                            <!-- Boutons pour séances actives futures -->
