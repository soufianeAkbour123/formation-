        ...
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('store.course') }}" method="post" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="date_debut" class="form-control" id="date_debut" placeholder="Date de début" required min="<?php echo date('Y-m-d'); ?>">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="date_fin" class="form-control" id="date_fin" placeholder="Date de fin" required min="<?php echo date('Y-m-d'); ?>">
...
<script>
    ...
    function validateDates() {
        ...
        $('#date_debut_error').html('').hide();
        $('#date_fin_error').html('').hide();
        ...
        if (dateDebut < today) {
            ...
            $('#date_debut_error').html('La date de début ne peut pas être dans le passé').show();
            isValid = false;
        }
        ...
        if (dateFin < dateDebut) {
            ...
            $('#date_fin_error').html('La date de fin doit être postérieure à la date de début').show();
            isValid = false;
        }
