...
<div class="page-content">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="date" name="date_debut" class="form-control" id="date_debut" placeholder="Date de début" value="{{ $course->date_debut }}" min="<?php echo date('Y-m-d'); ?>">
    </div>

    <div class="form-group col-md-6">
        <label for="date_fin" class="form-label">Date de fin</label>
        <input type="date" name="date_fin" class="form-control" id="date_fin" placeholder="Date de fin" value="{{ $course->date_fin }}" min="<?php echo date('Y-m-d'); ?>">
    </div>
