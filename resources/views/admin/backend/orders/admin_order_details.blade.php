...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Details de commande</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Details de commande</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                ...
                <div class="col-lg-6">
                    <div class="card"> 
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">Type de payment </h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
...
<div class="col-lg-6">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-sm-3">
                    <h6 class="mb-0">Le totale </h6>
                </div>
                <div class="col-sm-9 text-secondary">
                    <strong> {{ $payment->total_amount }} DHS</strong> 
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-sm-3">
            ...
            <div class="row mb-3">
                <div class="col-sm-3">
                    <h6 class="mb-0">ID de commande </h6>
                </div>
                <div class="col-sm-9 text-secondary">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                    ...
                    <a href="" class="btn btn-block btn-success">Confirmer la commande </a>
                    @endif 
...
@endphp
             ...
             <tr>
                <td colspan="4"></td>
                <td class="col-md-3">
                <strong>Total Prix : {{ $totalPrice }} DHS</strong>    
                </td>    
            </tr>             
                    </tbody>
                </table>
