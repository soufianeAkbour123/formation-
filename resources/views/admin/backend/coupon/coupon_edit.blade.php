...
<div class="page-content">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modifier un code promo
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Modifier un code promo
            </h5>
            <form id="myForm" action="{{ route('admin.update.coupon') }}" method="post" class="row g-3" enctype="multipart/form-data">
               ...
               <input type="hidden" name="id" value="{{ $coupon->id }}"> 
                ...
                <div class="form-group col-md-6">
                    <label for="input1" class="form-label">Nom de code promo</label>
