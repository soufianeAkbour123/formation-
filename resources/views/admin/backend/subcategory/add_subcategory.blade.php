...
<div class="page-content">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ajouter une Sous-Catégorie</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Ajouter une Sous-Catégorie</h5>
            <form id="myForm" action="{{ route('store.subcategory') }}" method="post" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6">
                    <label for="input1" class="form-label">Nom de la Sous-Catégorie</label>
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                category_id: {
                    required : 'Veuillez sélectionner le nom de la catégorie',
                }, 
