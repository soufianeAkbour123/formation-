    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a class="has-arrow" href="javascript:;">
                ...
                <div class="menu-title">Toutes les questions</div>
            </a>
            <ul>
                <li> <a href="{{ route('instructor.all.question') }}"><i class='bx bx-radio-circle'></i>Toutes les questions</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('instructor.all.review') }}"><i class='bx bx-radio-circle'></i>Tous les avis</a>
                </li>
