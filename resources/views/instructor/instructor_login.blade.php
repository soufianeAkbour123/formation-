                ...
                @enderror
											...
											<div class="col-12">
												<div class="text-center ">
													<p class="mb-0">Vous n'avez pas encore de compte ?<a href="authentication-signup.html">Inscrivez-vous ici</a>
													</p>
												</div>
											</div>
										</form>
									</div>
									<div class="login-separater text-center mb-5"> <span>OU CONNECTEZ-VOUS AVEC</span>
										<hr>
									</div>
