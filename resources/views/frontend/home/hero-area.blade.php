<section class="hero-area">
   <div class="hero-slider owl-action-styled">
       <!-- Premier slide - Logo -->
       <div class="hero-slider-item first-slide" style="padding: 80px 0; height: auto;">
            <div class="container">
   ...
   <style>
       /* Styles pour le premier slide */
       .hero-slider-item.first-slide {
           background: #ffffff;
           position: relative;
           z-index: 2;
       }

       .hero-slider-item.first-slide:after,
       .hero-slider-item.first-slide:before {
           display: none;
       }

       /* Styles pour le deuxième slide */
       .hero-slider-item:not(.first-slide) {
           position: relative;
           z-index: 2;
           padding-top: 200px;
       ...
       .hero-slider-item:not(.first-slide):after {
           position: absolute;
           left: 0;
           top: 0;
           height: 100%;
       ...
       .hero-slider-item:not(.first-slide):before {
           position: absolute;
           content: '';
           top: 0;
           left: 0;
