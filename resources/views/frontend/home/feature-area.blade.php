<section class="feature-area pb-90px">
    <div class="container">
        <div class="row feature-content-wrap">
            ...
            <a href="teachers.html" class="mon-lien">
                <div class="info-box">
                    ...
                    <div class="icon-element mx-auto shadow-sm">
                        ...
                        <h3 class="info__title">Formateurs experts</h3>
                        <p class="info__text">Cours avec des enseignants experts grâce à notre abonnement exclusif.</p>
            ...
            <div class="col-lg-4 responsive-column-half">
                <a href="career-details.html" class="mon-lien">
                <div class="info-box">
                    <div class="info-overlay"></div>
                    <div class="icon-element mx-auto shadow-sm">
                    ...
                    <h3 class="info__title">Multi-Certificats </h3>
                    <p class="info__text">  Accédez à plusieurs certificats avec notre abonnement exclusif.</p>
                </div><!-- end info-box -->
            </div>
        </a>
        
        
        <div class="col-lg-4 responsive-column-half" id="abonnement-section" style="cursor: pointer;">
    <div class="info-box">
        <div class="info-overlay"></div>
        <div class="icon-element mx-auto shadow-sm">
        ...
        <h3 class="info__title">Abonnement Simplifié !</h3>
        <p class="info__text">Cours en direct avec nos experts, exclusif et pratique.</p>
    </div><!-- end info-box -->
</div><!-- end col-lg-4 -->

<script>
    document.getElementById('abonnement-section').addEventListener('click', function() {
        window.location.href = "{{ route('pricing.table') }}";
    });
</script>
        </a>
