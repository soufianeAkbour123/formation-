@php
    $category = App\Models\Category::latest()->limit(8)->get();
@endphp
        ...
        <div class="row align-items-center">
            <div class="col-lg-9">
                <div class="category-content-wrap">
                    <div class="section-heading">
                        <h5 class="ribbon ribbon-lg mb-2">Catégories</h5>
            ...
            <div class="col-lg-3">
                <div class="category-btn-box text-right">
                    <a href="categories.html" class="btn theme-btn">Toutes les catégories <i class="la la-arrow-right icon ml-1"></i></a>
        ...
        <div class="category-item">
            ...
            <div class="category-content">
                <div class="category-inner">
                    ...
                    <a href="{{ url('category/'.$cat->id.'/'.$cat->category_slug) }}" class="btn theme-btn theme-btn-sm theme-btn-white">Explorer<i class="la la-arrow-right icon ml-1"></i></a>
                </div>
