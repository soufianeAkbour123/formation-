                                                ...
                                                <!-- <ul class="cart-dropdown-menu after-none">
                                                    <li class="media media-card">
                                                        ...
                                                        <div class="media-body">
                                                            <h5><a href="shopping-cart.html">Le cours complet de JavaScript 2021 : De zéro à expert !</a></h5>
                                                            <span class="d-block lh-18 py-1">AKBOUR Soufiane</span>
                                                            <p class="text-black font-weight-semi-bold lh-18">$120.99 <span class="before-price fs-14">$129.99</span></p>
                                                        </div>
                                                    </li>
                                                    <li class="media media-card">
                                                        <a href="shopping-cart.html" class="media-img">
                                                        ...
                                                        <div class="media-body">
                                                            <h5><a href="shopping-cart.html">Le cours complet de JavaScript 2021 : De zéro à expert !</a></h5>
                                                            <span class="d-block lh-18 py-1">AKBOUR Soufiane</span>
                                                            <p class="text-black font-weight-semi-bold lh-18">$190.99 <span class="before-price fs-14">$129.99</span></p>
                                                        </div>
                                                    </li>
                                                    <li class="media media-card">
                                                        <div class="media-body fs-16">
                                                            <p class="text-black font-weight-semi-bold lh-18">Total: <span class="cart-total">$2100.99</span> <span class="before-price fs-14">$3300.99</span></p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <a href="shopping-cart.html" class="btn theme-btn w-100">Aller au panier <i class="la la-arrow-right icon ml-1"></i></a>
                                                    </li>
                                                </ul> -->
                                            </li>
                                        </ul>
                                                ...
                                                <!-- <ul class="cart-dropdown-menu after-none">
                                                    <li>
                                                        <div class="media media-card">
                                                            ...
                                                            <div class="media-body">
                                                                <h5><a href="course-details.html">Le cours complet de JavaScript 2021 : De zéro à expert !</a></h5>
                                                                <span class="d-block lh-18 py-1">AKBOUR Soufiane</span>
                                                                <p class="text-black font-weight-semi-bold lh-18">$12.99 <span class="before-price fs-14">$129.99</span></p>
                                                            </div>
                                                        </div>
                                                        <a href="#" class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 w-100 mt-3">Ajouter au panier <i class="la la-arrow-right icon ml-1"></i></a>
                                                    </li>
                                                    <li>
                                                        <div class="media media-card">
                                                            <a href="course-details.html" class="media-img">
                                                            ...
                                                            <div class="media-body">
                                                                <h5><a href="course-details.html">Le cours complet de JavaScript 2021 : De zéro à expert !</a></h5>
                                                                <span class="d-block lh-18 py-1">AKBOUR Soufiane</span>
                                                                <p class="text-black font-weight-semi-bold lh-18">$120.99 <span class="before-price fs-14">$1080.99</span></p>
                                                            </div>
                                                        </div>
                                                        <a href="#" class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 w-100 mt-3">Ajouter au panier <i class="la la-arrow-right icon ml-1"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="my-courses.html" class="btn theme-btn w-100">Ajouter à la liste de souhaits <i class="la la-arrow-right icon ml-1"></i></a>
                                                    </li>
                                                </ul> -->
                                            </li>
                                        </ul>
