        ...
        <div class="row">
            <div class="col-lg-7 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        <h3 class="card-title text-center fs-24 lh-35 pb-4">Connectez-vous à votre compte </h3>
                            ...
                            <div class="btn-box">
                                <div class="d-flex align-items-center justify-content-between pb-4">
                                    <div class="custom-control custom-checkbox fs-15">
                                        ...
                                        <label class="custom-control-label custom--control-label" for="rememberMeCheckbox">Se souvenir de moi.</label>
                                    </div><!-- end custom-control -->
                                    <a href="recover.html" class="btn-text">Mot de passe oublié ?</a>
                                </div>
                                <button class="btn theme-btn" type="submit">Compte de connexion <i class="la la-arrow-right icon ml-1"></i></button>
                                <p class="fs-14 pt-2">Vous n'avez pas de compte ? <a href="sign-up.html" class="text-color hover-underline">Register</a></p>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
