    ...
    <div class="setting-body">
        ...
        @csrf
            ...
            <div class="input-box col-lg-12">
                <label class="label-text">Ancien mot de passe </label>
            ...
            <div class="input-box col-lg-12">
                <label class="label-text">Nouveau mot de passe</label>
                <div class="form-group">
            ...
            <div class="input-box col-lg-12">
                <label class="label-text">Confirmer le nouveau mot de passe</label>
                <div class="form-group">
            ...
            <div class="input-box col-lg-12 py-2">
                <button class="btn theme-btn">Sauvegarder les modifications</button>
            </div><!-- end input-box -->
        </form>
