...
class QuestionController extends Controller
{
    ...
    public function InstructorAllQuestion(){
        ...
        $totalUnread = Question::where('instructor_id', $id)
                              ->where('is_read', false)
                              ->count();
        
        // Récupérer les questions avec le compteur de messages non lus par conversation
        ...
        return view('instructor.question.all_question', compact('question', 'totalUnread'));
    }
